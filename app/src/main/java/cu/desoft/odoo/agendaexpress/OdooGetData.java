...
//        phone = (EditText) findViewById(R.id.editTextPhoneC);
    ...
    private class ConnectionOdoo extends AsyncTask<Void, ArrayList<String>, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            List<HashMap<String, Object>> data = oc.search_read("res.partner",
                    new Object[]{ new Object[]{new Object[]{"customer", "=", true}}},
                    "name");
            ...
            switch (act) {
                ...
                msgResult = "ConnectionOdoo: UnKnow Connection error";
                return false;
            }
            return true;
        }
